...
EasyNex::EasyNex(HardwareSerial &serial)
...
{
  _serial->begin(baud, SERIAL_8N1, RX_PIN, TX_PIN); // We pass the initialization data to the objects (baud rate) default: 9600
